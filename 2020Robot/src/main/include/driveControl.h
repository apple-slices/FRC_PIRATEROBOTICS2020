...
class PHHSDrive{
    ...
    float sensativityChange = 0.9; //when the piecewise switches sensativity
    float startingSensativity = 0.20; //starting sensativity before the switch
